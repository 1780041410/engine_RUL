...
def prepareData():
    ...
    real_RUL = pd.read_table('early_RUL_data.txt',delim_whitespace=True,header=None,names=index_c,encoding='utf-8')   

    train_X_temp  = pd.read_table('early_failed_training_set.txt',delim_whitespace=True,header=None,names=index_14f_with_ID,encoding='utf-8')

    test_X_temp   = pd.read_table('early_failed_testing_set.txt',delim_whitespace=True,header=None,names=index_14f_with_ID,encoding='utf-8')

    train_y_temp  = pd.read_table('early_train_y.txt',delim_whitespace=True,header=None,names=index_y,encoding='utf-8')
